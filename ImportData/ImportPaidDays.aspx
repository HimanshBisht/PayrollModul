<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="ImportPaidDays.aspx.cs" Inherits="SalaryModule_ImportPaidDays" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="margin-top: 25px; height: auto;">
                ...
                <fieldset>
                    <center>
                        <legend>Import Employees Paid Days</legend>
                        ...
                        <asp:Panel ID="pnlData" runat="server">
                            ...
                            <table style="margin: 5px 0 0 21px;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnDownloadTemplate" runat="server" Text="Download Template" ValidationGroup="Save" OnClick="btnDownloadTemplate_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                ...
                                <tr>
                                    <td>
                                        <asp:FileUpload ID="flImportPaidDays" runat="server" />
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSaveTemplate" runat="server" Text="Save Template" Width="110px" ValidationGroup="Save" OnClick="btnSaveTemplate_Click" />
                                        <asp:Button ID="btnCancel" Text="Cancel" runat="server" Width="100px" OnClick="btnCancel_Click" />
