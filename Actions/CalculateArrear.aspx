<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="CalculateArrear.aspx.cs" Inherits="SalaryModule_CalculateArrear" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Calculate Arrear"></asp:Label>
                                </td>
            ...
            <asp:Panel ID="pnlPrint" runat="server">
                    ...
                    <center>
                        <asp:Panel ID="pnlButtons" runat="server" Style="margin-top: 30px;">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnCalculateArrear" runat="server" CssClass="btn btn-default" Text="Calculate Arrear" OnClientClick="return ConfirmHRA()" OnClick="btnCalculateArrear_Click" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                ...
                <asp:Panel ID="pnlArrear" runat="server" Visible="false">
                    <center>
                        <legend>Final Details For Arrear</legend>
                    </center>
                    <asp:Panel ID="pnlArrearAmount" runat="server" Style="margin-top: 30px; max-height: 550px; width: 100%; overflow: auto; margin-bottom: 20px;">
                        <center>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Font-Size="18px" Text="Arrear Gross Total Salary"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label5" runat="server" Font-Size="18px" Text=" : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblArrearGrossTotalSalary" runat="server" Font-Size="18px" Text="0.00"></asp:Label>
                                    </td>
                                    ...
                                    <td style="width: 70px;"></td>
                                    <td>
                                        <asp:Label ID="Label11" runat="server" Font-Size="18px" Text="Total Arrear Amount"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label12" runat="server" Font-Size="18px" Text=" : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblTotalArrearAmount" runat="server" Font-Size="18px" Text="0.00"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="7">
                            ...
                            <center>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label9" runat="server" Font-Size="18px" Text="Pre Arrear Amount"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label10" runat="server" Font-Size="18px" Text=" : "></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblPreArrearAmount" runat="server" Font-Size="18px" Text="0.00"></asp:Label>
                                        </td>
                                        <td style="width: 70px;"></td>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Font-Size="18px" ForeColor="Red" Text="Final Arrear Amount"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label6" runat="server" Font-Size="18px" Text=" : "></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblFinalArrearAmount" runat="server" Font-Size="18px" Text="0.00"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="7">
            ...
            <asp:Panel ID="pnlSaveSection" runat="server" Visible="false">
                <center>
                    <legend>Select Month and Year in which you want to save the Arrear Details.</legend>
                    <table>
                        <tr>
                            <td>
                                <asp:DropDownList ID="ddlArrearMonth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlArrearMonth_SelectedIndexChanged"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlArrearMonth" ErrorMessage="*" ForeColor="Red" InitialValue="0" ValidationGroup="Save"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlArrearYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlArrearYear_SelectedIndexChanged"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlArrearMonth" ErrorMessage="*" InitialValue="0" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnSaveArrear" runat="server" CssClass="btn btn-default" Text="Save Arrear" ValidationGroup="Save" OnClientClick="return ConfirmSave()" OnClick="btnSaveArrear_Click" />
                            </td>
                            <td>
