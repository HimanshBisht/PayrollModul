<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="DeductionMaking.aspx.cs" Inherits="SalaryModule_DeductionMaking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmDeactivate() {
            if (confirm("Make Sure that all Pending Deduction Amount will be '0.00' for this Employee. Are you sure you want to Deactivate this Record?") == true) {
                return true;
            }
            else {
                return false;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="margin-top: 25px; height: auto;">
                <fieldset>
                    <center>
                        <legend>Deduction Making</legend>
                        <asp:Panel ID="pnlSelectEmployee" runat="server">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblFill" runat="server" Font-Bold="true" Text="To Fill Deduction"></asp:Label>
                                    </td>
                        ...
                        <asp:Panel ID="pnlPending" runat="server" Visible="false">
                            <table>
                                <tr>
                                    ...
                                    <td style="width: 10px;"></td>
                                    <td>
                                        <asp:Button ID="btnAddDeductionAmount" runat="server" CssClass="btn btn-default" OnClick="btnAddDeductionAmount_Click" />
                                    </td>
                                    <td></td>
                                    <td>
                        ...
                        <asp:Panel ID="pnlFillData" runat="server" Visible="false">
                            <table>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtAddAmount" runat="server" placeholder="Amount For Deduction" AutoComplete="off"></asp:TextBox>
                                ...
                                <asp:Panel ID="pnlStructure" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblRemarks" runat="server" Text="Remaks"></asp:Label>
                                        </td>
                                        <td>:</td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Rows="3" Width="94%" placeholder="Please Mention Some Remarks for Deduction."></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtRemarks" ErrorMessage="*" ForeColor="Red" ValidationGroup="GetStructure"></asp:RequiredFieldValidator>
                                        </td>
                                        <td colspan="4"></td>
                                    </tr>
                                    <tr>
                        ...
                        <asp:Panel ID="pnlDetail" runat="server" Visible="false">
                            ...
                            <table style="float: left;">
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSaveDeduction" runat="server" Text="Save Deduction" CssClass="btn btn-default" OnClick="btnSaveDeduction_Click" />
                                    </td>
                                </tr>
                            </table>
                            <asp:GridView ID="grdrecord" runat="server" Style="margin-top: 20px;" AutoGenerateColumns="false" Width="100%" ShowFooter="true" OnRowDataBound="grdrecord_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Monthly Recovery Amount">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblNetDeductionAmount" runat="server"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Remarks for Deduction">
                                        <ItemTemplate>
                        ...
                        <asp:Panel ID="pnlUpdate" runat="server" Visible="false">
                            <table style="float: left;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnUpdateStructure" runat="server" Text="Update Deduction" CssClass="btn btn-default" OnClick="btnUpdateStructure_Click" OnClientClick="return ConfirmUpdate()" />
                                    </td>
                                    <td>
                            ...
                            <asp:GridView ID="grdUpdate" runat="server" Style="margin-top: 20px;" AutoGenerateColumns="false" Width="100%" ShowFooter="true" OnRowDataBound="grdUpdate_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Deduction Import ID" Visible="False">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDedImportID" runat="server" Text='<%# Eval("DedImportID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Recovery Type" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDeductionRecoveryType" runat="server" Text='<%# Eval("DeductionRecoveryType") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Year">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Monthly Recovery Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMonthlyAmount" runat="server" AutoPostBack="true" OnTextChanged="txtMonthlyAmount_TextChanged" placeholder="Enter Monthly Recovery" Text='<%# Eval("DeductionValue") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Remarks For Deduction">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRemarks" runat="server" placeholder="Enter Remarks" Text='<%# Eval("Remarks") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
