...
public partial class SalaryModule_PendingIDFReport : System.Web.UI.Page
{
    string constr = "";
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    public void Employee()
    {
        ...
        {
            SqlConnection con = new SqlConnection(constr);
            cmd = new SqlCommand("GetPendingIDFRecords", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    public void Bindgrid()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblSTMT.Text = "K.R.Mangalam World School, Faridabad <br /> Pending IDF Report of " + ddlYear.SelectedItem.Text + "-" +
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Pending_IDF_Report_FDB.xls");
            Response.Charset = "";
