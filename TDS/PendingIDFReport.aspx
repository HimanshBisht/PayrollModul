<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master"
    AutoEventWireup="true" CodeFile="PendingIDFReport.aspx.cs" Inherits="SalaryModule_PendingIDFReport" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 20px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Pending IDF Report"></asp:Label>
                                </td>
                                ...
                                <asp:Panel ID="pnlTotalRecords" runat="server" Visible="false">
                                    <td>
                                        <asp:Label ID="lblTotal" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="15px"
                                            Text="Total Pending Record : "></asp:Label>
                                    </td>
                                    <td>
