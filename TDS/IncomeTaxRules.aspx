<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="IncomeTaxRules.aspx.cs" Inherits="SalaryModule_IncomeTaxRules" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="margin-top: 25px; height: auto;">
                <fieldset>
                    <center>
                        <legend>Year Wise Income Tax Rules Set Up</legend>
                        <asp:Panel ID="pnlData" runat="server">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIncomeTaxRates" runat="server" placeholder="Mention Only % Figure" AutoComplete="off"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" TargetControlID="txtIncomeTaxRates"
                                            FilterMode="ValidChars" ValidChars="0123456789.">
                                        </asp:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtIncomeTaxRates" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Education Cess(%)</td>
                                    <td>
                                        <asp:TextBox ID="txtEducationCess" runat="server" placeholder="Mention Only % Figure" AutoComplete="off"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" TargetControlID="txtEducationCess"
                                            FilterMode="ValidChars" ValidChars="0123456789.">
                                        </asp:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtEducationCess" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </td>
                                    <td style="width: 15px;"></td>
                                    <td>Higher Education Cess(%)</td>
                                    <td>
                                        <asp:TextBox ID="txtHigherEducationCess" runat="server" placeholder="Mention Only % Figure" AutoComplete="off"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" TargetControlID="txtHigherEducationCess"
                                            FilterMode="ValidChars" ValidChars="0123456789.">
                                        </asp:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtHigherEducationCess" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </td>
                                    <td style="width: 15px;"></td>
                                    <td>Special Case</td>
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlSpecialCase" ErrorMessage="*" InitialValue="0" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="8">
                        ...
                        <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" OnRowCommand="grdrecord_RowCommand" Width="100%">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="lnkEdit" CommandArgument='<%#Eval("IncomeTaxRuleID") %>' />
                                        / 
                                        <asp:LinkButton ID="lnkDeactivate" runat="server" Text="Deactivate" OnClientClick="return ConfirmDeactivate()" CommandName="lnkDeactivate" CommandArgument='<%#Eval("IncomeTaxRuleID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField HeaderText="Income Rates (%)" DataField="IncomeTaxRates" />
                                <asp:BoundField HeaderText="Education Cess (%)" DataField="EducationCess" />
                                <asp:BoundField HeaderText="Higher Edu. Cess (%)" DataField="HigherEducationCess" />
                                <asp:BoundField HeaderText="Special Case" DataField="SpecialCaseText" />
