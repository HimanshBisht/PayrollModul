...
public partial class SalaryModule_StandardDeduction : System.Web.UI.Page
{
    string constr = "";
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    public void Bindgrid()
    {
        ...
        {
            SqlConnection con = new SqlConnection(constr);
            cmd = new SqlCommand("ManageStandardDeduction", con);
    ...
    public void Clear()
    {
        try
        {            
            txtDedValue.Text = string.Empty;
            ViewState["StandDedID"] = null;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("ManageStandardDeduction", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@DedValue", txtDedValue.Text);
            cmd.Parameters.AddWithValue("@StandDedID", Convert.ToInt32(ViewState["StandDedID"]));
    ...
    protected void grdrecord_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "lnkEdit")
            {
                ...
                cmd = new SqlCommand("ManageStandardDeduction", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@StandDedID", e.CommandArgument);
                cmd.Parameters.AddWithValue("@Type", "GetRecords");
                cmd.Parameters.AddWithValue("@User", null);
                con.Open();
                DataTable dt = new DataTable();
                ...
                da.Fill(dt);
                con.Close();                
                txtDedValue.Text = dt.Rows[0]["DedValue"].ToString();
                ViewState["StandDedID"] = e.CommandArgument;
