<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="TDSHeaderwiseRules.aspx.cs" Inherits="SalaryModule_TDSHeaderwiseRules" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckLengthHeads(e) {
            var textHeads = document.getElementById("ContentPlaceHolder1_txtHeadRule");
            if (textHeads != null) {
                if (textHeads.value.trim().length >= 1000) {
                    textHeads.value = textHeads.value.substring(0, 1000);
                    CheckHeadsCharacter();
                    return false;
                }
            }
        ...
        function CheckHeadsCharacter() {
            var textHeads = document.getElementById("ContentPlaceHolder1_txtHeadRule").value;
        ...
        <ContentTemplate>
            <div style="margin-top: 25px; height: auto;">
                <fieldset>
                    <center>
                        <legend>
                            <asp:Label ID="lblHeaderText" runat="server" Text="Making TDS Rules according to selected Header" Font-Bold="true" Font-Size="18px"></asp:Label>
                        </legend>
                        <center>
                            <table>
                                <tr>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Visible="false">
                            <table>
                                <tr>
                                    <td>
                                        <h4>Define Selected Header wise TDS Rules</h4>
                                    </td>
                                    <td style="width: 20px;"></td>
                                    <td>
                                        <asp:TextBox ID="txtHeadRule" runat="server" autocomplete="off" TextMode="MultiLine" Width="500px" Rows="4" placeholder="Define Rules that will be display in 'Investment Declaration Form' (Max 1000 Characters)."
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtHeadRule" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"></td>
                        ...
                        <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" OnRowCommand="grdrecord_RowCommand" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="lnkEdit" CommandArgument='<%#Eval("RuleID") %>' />
                                        / 
                                        <asp:LinkButton ID="lnkDeactivate" runat="server" Text="Deactivate" OnClientClick="return ConfirmDeactivate()" CommandName="lnkDeactivate" CommandArgument='<%#Eval("RuleID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Header" DataField="HeaderText" />
                                <asp:BoundField HeaderText="Rule Text" DataField="RuleText" />
