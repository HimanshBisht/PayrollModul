<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master"
    AutoEventWireup="true" CodeFile="IDFApproval.aspx.cs" Inherits="SalaryModule_IDFApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ConfirmApproved() {
            if (confirm("Make sure After IDF Approval, No Modification can be done in IDF Form. Are you sure you want to Approved this IDF?") == true)
                return true;
            else
                return false;
        }       
        ...
        <ContentTemplate>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 20px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="IDF Approval"></asp:Label>
                                </td>
            ...
            <asp:Panel ID="pnlApproval" runat="server" Visible="false">
                <table>
                    <tr>
                        <td>
                            <asp:Button ID="btnApproved" runat="server" Text="Approved IDF" OnClientClick="return ConfirmApproved()" CssClass="btn btn-default" OnClick="btnApproved_Click" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
