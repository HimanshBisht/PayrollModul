<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="EmpNatureSetup.aspx.cs" Inherits="SalaryModule_EmpNatureSetup" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="margin-top: 25px; height: auto;">
                ...
                <fieldset>
                    <center>
                        <legend>Nature of Employee Set Up</legend>
                        ...
                        <asp:Panel ID="pnlData" runat="server">
                            ...
                            <table style="margin: 5px 0 0 21px;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNature" runat="server" autocomplete="off" placeholder="Define Type of Nature"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtNature" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                        ...
                        <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" OnRowCommand="grdrecord_RowCommand" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="lnkEdit" CommandArgument='<%#Eval("NatureID") %>' />
                                        / 
                                        <asp:LinkButton ID="lnkDeactivate" runat="server" Text="Deactivate" OnClientClick="return ConfirmDeactivate()" CommandName="lnkDeactivate" CommandArgument='<%#Eval("NatureID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
