...
public partial class SalaryModule_BankTransferReport : System.Web.UI.Page
{
    string constr = "";
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    public void Employee(int? EmployeeID)
    {
        try
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@ModeOfSalary", ModeOFSalary.BankAccount);
            ...
            ddlemployee.Items.Insert(0, new ListItem("All Bank A/C Employees", "0"));
            con.Close();
        }
        catch (Exception ex)
        {
    ...
    public void GetNarration()
    {
        try
        {
            foreach (GridViewRow row in grdrecord.Rows)
            {
                ...
                lblNarration.Text = "Salary " + ddlMonth.SelectedItem.Text.Substring(0, 3) + " - " + ddlYear.SelectedItem.Text;
            }
        }
        catch (Exception ex)
        {
    ...
    public void Bindgrid()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblSTMT.Text = "K.R.Mangalam World School, Faridabad " + "<br />" + "Salary Statement For the Month of " + ddlMonth.SelectedItem.Text + " - " + ddlYear.SelectedItem.Text + "<br />" + "Yes Bank, Saving A/c No. 006194600000811";
            }
            else
            {
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Bank_Transfer_Report_" + ddlMonth.SelectedItem.Text.Substring(0, 3) + " - " + ddlYear.SelectedItem.Text + "_FDB.xls");
            Response.Charset = "";
