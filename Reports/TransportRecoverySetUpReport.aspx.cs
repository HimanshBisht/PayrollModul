...
public partial class SalaryModule_TransportRecoverySetUpReport : System.Web.UI.Page
{
    string constr = "";
    SqlConnection con;
    SqlCommand cmd;
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=TPTRec Setup Report.xls");
            Response.Charset = "";
