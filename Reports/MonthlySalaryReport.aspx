<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="MonthlySalaryReport.aspx.cs" Inherits="SalaryModule_MonthlySalaryReport" EnableEventValidation="false" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Monthly Salary Report"></asp:Label>
                                </td>
                            ...
                            <table class="grdTable">
                                ...
                                <tr>
                                    <td style="width: 500px;">
                                        <asp:Label ID="lblPreparedByName" runat="server" Font-Bold="true" Font-Size="20px"></asp:Label>
                                    </td>
                                    <td colspan="5"></td>
                                    <td style="width: 500px;">
                                        <asp:Label ID="lblCheckedByName" runat="server" Font-Bold="true" Font-Size="20px"></asp:Label>
                                    </td>
                                    <td colspan="5"></td>
                                    <td style="width: 500px;">
                                        <asp:Label ID="lblScrutinizedByName" runat="server" Font-Bold="true" Font-Size="20px"></asp:Label>
                                    </td>
                                    <td colspan="5"></td>
                                    <td style="width: 500px;">
                                        <asp:Label ID="lblPrincipalName" runat="server" Font-Bold="true" Font-Size="20px"></asp:Label>
                                    </td>
                                    <td colspan="5"></td>
                                    <td style="width: 500px;">
                                        <asp:Label ID="lblChairmanName" runat="server" Font-Bold="true" Font-Size="20px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="25">
