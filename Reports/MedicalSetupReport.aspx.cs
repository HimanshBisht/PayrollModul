...
public partial class SalaryModule_MedicalSetupReport : System.Web.UI.Page
{
    string constr = "";
    SqlConnection con;
    SqlCommand cmd;
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Medical Allow Setup Report.xls");
            Response.Charset = "";
