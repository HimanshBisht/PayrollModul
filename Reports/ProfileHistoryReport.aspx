<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="ProfileHistoryReport.aspx.cs" Inherits="SalaryModule_ProfileHistoryReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Profile Modification Report"></asp:Label>
                                </td>
                                <td style="width: 600px;"></td>
                                <asp:Panel ID="pnlTotalRecords" runat="server" Visible="false">
                                    <td>
                                        <asp:Label ID="lblTotal" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="15px" Text="Total Updated Employees : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblTotalEmployees" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="15px"></asp:Label>
                                    </td>
                                </asp:Panel>
                            </tr>
                        </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlModeOfSalary" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlModeOfSalary_SelectedIndexChanged">
                                            <asp:ListItem Text="All Salary Mode" Value="0"></asp:ListItem>
            ...
            <asp:Panel ID="pnlDetail" runat="server" Visible="false" Style="margin-top: 30px; max-height: 500px; width: 100%; overflow: auto; margin-bottom: 20px;">
                <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" CssClass="grdTable" AllowPaging="true" PageSize="300"
