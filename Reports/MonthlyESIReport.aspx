<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="MonthlyESIReport.aspx.cs" Inherits="SalaryModule_MonthlyESIReport" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Monthly Staff ESI Contribution Statement Report"></asp:Label>
                                </td>
                ...
                <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" OnRowDataBound="grdrecord_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Gross Amount">
                            ...
                            <FooterTemplate>
                                <asp:Label ID="lblGrandGrossTotal" runat="server"></asp:Label>
                            </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Employer Contribution"></asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                        No Record Found
                    </EmptyDataTemplate>
