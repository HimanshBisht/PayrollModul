<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="MonthlySalaryCashEmpReport.aspx.cs" Inherits="SalaryModule_MonthlySalaryCashEmpReport" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Monthly Salary Report of Cash Employees"></asp:Label>
                                </td>
