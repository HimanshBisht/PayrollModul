<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="GISSetupReport.aspx.cs" Inherits="SalaryModule_GISSetupReport" %>
                ...
                <fieldset>
                    <center>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <legend>Group Insurance Scheme (GIS) Set Up Report</legend>
                                </td>
                                <td>
                    ...
                    <asp:Panel ID="pnlDetail" runat="server" Style="margin-top: 30px; max-height: 500px; width: 100%; overflow: auto; margin-bottom: 20px;">
                        ...
                        <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="GIS Name" DataField="GISName" />
                                <asp:BoundField HeaderText="GIS Value" DataField="GISValue" />
