<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="ESISetupReport.aspx.cs" Inherits="SalaryModule_ESISetup" %>
                ...
                <fieldset>
                    <center>
                        <table>
                            <tr>
                                <td>
                                    <legend>Employee State Insurance (ESI) Set Up Report</legend>
                                </td>
                                <td>
