<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="RecoveryReport.aspx.cs" Inherits="SalaryModule_RecoveryReport" EnableEventValidation="false" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Recovery Report"></asp:Label>
                                </td>
                        ...
                        <center>
                            <table style="margin: 15px 0 0 21px;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnSearch" runat="server" Text="Get Recovery Report" CssClass="btn btn-default" ValidationGroup="Search" OnClick="btnSearch_Click" />
                                    </td>
                                    <td>
            ...
            <asp:Panel ID="pnlMonthlyReport" runat="server" Style="margin-top: 30px; max-height: 550px; width: 100%; overflow: auto; margin-bottom: 20px;" Visible="false">
                <asp:GridView ID="grdMonthlyReport" runat="server" AutoGenerateColumns="false" Width="100%" OnRowCommand="grdMonthlyReport_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Recovery Amount" DataField="DeductionValue" />
                        <asp:BoundField HeaderText="Remarks" DataField="Remarks" />
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDeactivate" runat="server" Text="Deactivate" OnClientClick="return ConfirmDeactivate()" CommandName="lnkDeactivate" CommandArgument='<%#Eval("DedImportID") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
