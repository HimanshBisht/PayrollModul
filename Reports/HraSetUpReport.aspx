<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="HraSetUpReport.aspx.cs" Inherits="SalaryModule_HraSetupReport" %>
                ...
                <fieldset>
                    <center>
                        <table>
                            <tr>
                                <td>
                                    <legend>House Rent Allowance (HRA) Set Up Report</legend>
                                </td>
                                <td>
