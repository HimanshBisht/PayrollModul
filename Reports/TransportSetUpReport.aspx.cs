...
public partial class SalaryModule_TransportSetupReport : System.Web.UI.Page
{
    string constr = "";
    SqlConnection con;
    SqlCommand cmd;
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Transport Allow Setup Report.xls");
            Response.Charset = "";
