...
public partial class SalaryModule_MonthlySalaryChequeEmpReport : System.Web.UI.Page
{
    string constr = "";
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    public void Employee(int? EmployeeID)
    {
        try
        {
            ...
            ddlemployee.Items.Insert(0, new ListItem("All Cheque Employees", "0"));
            con.Close();
        }
        catch (Exception ex)
        {
    ...
    private void ExportGridToExcel()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Salary_Report_of_Cheque_Emp_" + ddlMonth.SelectedItem.Text.Substring(0, 3) + " - " + ddlYear.SelectedItem.Text + "_FDB.xls");
            Response.Charset = "";
