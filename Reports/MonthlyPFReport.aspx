<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="MonthlyPFReport.aspx.cs" Inherits="SalaryModule_MonthlyPFReport" %>
                ...
                <fieldset>
                    <center>
                        <table style="margin: 30px 0 0 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblReport" runat="server" Font-Bold="true" Font-Size="15px" Text="Monthly Staff PF Statement Report"></asp:Label>
                                </td>
                ...
                <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" OnRowDataBound="grdrecord_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Paid Days">
                            <ItemTemplate>
                                <asp:Label ID="lblDAForReport" runat="server" Text='<%# Eval("PaidDays") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="EPF Amount">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Diff. Amount"></asp:TemplateField>
                        <asp:TemplateField HeaderText="FPF Amount"></asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                        No Record Found
                    </EmptyDataTemplate>
