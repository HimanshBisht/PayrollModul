<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SalaryMaster.master" AutoEventWireup="true" CodeFile="ProfileReportNew.aspx.cs" Inherits="SalaryModule_ProfileReportNew" %>
                    ...
                    <center>
                        ...
                        <asp:Panel ID="pnlData" runat="server">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="ddlScaleChange" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlScaleChange_SelectedIndexChanged">
                                            <asp:ListItem Text="All Scale Employees" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="All Scale Change" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="All Non Scale Change" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
            ...
            <asp:Panel ID="pnlDetail" runat="server" Visible="false" Style="margin-top: 30px; max-height: 500px; width: 100%; overflow: auto; margin-bottom: 20px;">
                <asp:GridView ID="grdrecord" runat="server" AutoGenerateColumns="false" CssClass="grdTable"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Assign Code" DataField="AssignEmpCode" />
                        ...
                        <asp:BoundField HeaderText="Change Scale" DataField="ChangeScaleText" />
                        <asp:BoundField HeaderText="Effected Scale" DataField="EffectedScale" />
                        ...
                        <asp:BoundField HeaderText="ReimbursementFor1" DataField="ReimbursementFor1" />
                        <asp:BoundField HeaderText="ReimbursementValue1" DataField="ReimbursementValue1" />
                        <asp:BoundField HeaderText="ReimbursementFor2" DataField="ReimbursementFor2" />
                        <asp:BoundField HeaderText="ReimbursementValue2" DataField="ReimbursementValue2" />
                        <asp:BoundField HeaderText="ReimbursementFor3" DataField="ReimbursementFor3" />
                        <asp:BoundField HeaderText="ReimbursementValue3" DataField="ReimbursementValue3" />
                        <asp:BoundField HeaderText="ReimbursementFor4" DataField="ReimbursementFor4" />
                        <asp:BoundField HeaderText="ReimbursementValue4" DataField="ReimbursementValue4" />
                        <asp:BoundField HeaderText="ReimbursementFor5" DataField="ReimbursementFor5" />
                        <asp:BoundField HeaderText="ReimbursementValue5" DataField="ReimbursementValue5" />
                        <asp:BoundField HeaderText="TotalReimbursement" DataField="TotalReimbursement" />
